...
class LecturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecturer" do
    assert_difference("Lecturer.count") do
      post lecturers_url, params: { lecturer: { course_id: @lecturer.course_id, email: @lecturer.email, name: @lecturer.name } }
    end
  ...
  test "should update lecturer" do
    patch lecturer_url(@lecturer), params: { lecturer: { course_id: @lecturer.course_id, email: @lecturer.email, name: @lecturer.name } }
